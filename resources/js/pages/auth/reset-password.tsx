...
export default function ResetPassword({ token, email }: ResetPasswordProps) {
    return (
        <AuthLayout title={__('reset_password_title')} description={__('reset_password_description')}>
            ...
            >
                {({ processing, errors }) => (
                    <div className="grid gap-6">
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="password_confirmation">{__('reset_password_confirm_password')}</Label>
                            <Input
